...
test_data = '/home/kate/minecraft_utils/llm_annotator/parser_test_moves_full.jsonl'
save_data = '/home/kate/minecraft_utils/llm_annotator/test-output-generate-llama3-fullTEST.txt'
# device_map = "auto"
...
test_dataset = load_dataset("json", data_files={'test':'/home/kate/minecraft_utils/llm_annotator/parser_test_moves_full.jsonl'})["test"]
...
#f = open("/home/kate/minecraft_utils/llm_annotator/test-output-generate-llama3-fullTEST.txt","w")

new_generations = None
previous_generations = None
First_move = 0
for datum in tqdm(test_dataset['sample'][:40]):
