...
device_map = "auto"
model = AutoModelForCausalLM.from_pretrained("/tmpdir/thompson/llama-trois-parser-nostruct",return_dict=True,torch_dtype=torch.float16,device_map=device_map)
...
test_dataset = load_dataset("json", data_files={'test':'/tmpdir/thompson/parser_data/parser_test_moves_15_nostructure.jsonl'})["test"] 
...
# f = open("/tmpdir/thompson/llama-trois-parser_stacling/val-output-file.txt","w")
...
f = open("/tmpdir/thompson/llama-trois-parser-nostruct/test-output-file-nostruct.txt","w")
