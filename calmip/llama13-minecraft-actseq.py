...
new_model = "/tmpdir/thompson/llama-2-13b-minecraft-actseq_narr_3e"
...
dataset = load_dataset("csv", data_files={'train':'/tmpdir/thompson/minecraft/actseq-train-narr-small-v2.csv'})["train"]
...
output_merged_dir = "/tmpdir/thompson/llama-2-13b-minecraft-actseq_narr_3e"
