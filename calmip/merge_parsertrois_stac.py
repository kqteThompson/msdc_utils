...
device_map = "auto"
model = AutoModelForCausalLM.from_pretrained("/tmpdir/thompson/llama-trois-parser_stacling",return_dict=True,torch_dtype=torch.float16,device_map=device_map)
...
test_dataset = load_dataset("json", data_files={'test':'/tmpdir/thompson/parser_data/parser_stac_linguistic_test_15_checked.jsonl'})["test"]
...
f = open("/tmpdir/thompson/llama-trois-parser_stacling/test-output-file.txt","w")
