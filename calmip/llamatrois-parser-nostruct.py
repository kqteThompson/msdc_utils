...
new_model = "/tmpdir/thompson/llama-trois-parser-nostruct"
...
dataset = load_dataset("json", data_files={'train':'/tmpdir/thompson/parser_data/parser_train_moves_15_nostructure.jsonl'})["train"]
#al_dataset = load_dataset("json", data_files={'val':'/tmpdir/thompson/parser_data/parser_val_moves_15.jsonl'})["val"]
...
output_merged_dir = "/tmpdir/thompson/llama-trois-parser-nostruct"
