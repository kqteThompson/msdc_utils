...
def is_rectangle_unfilled(net_act_seq):
    ...
    if x_min==x_max and y_max-y_min>0:
       ...
       if set(coords_list)==set(rect_l):
           flag = True
           return flag, ((x_max-x_min+1),(y_max-y_min+1))    
    return flag
...
if __name__=="__main__":
    act_seq = ['place red -4 3 1', 'place red -4 3 0', 'place red -4 3 -1', 'place red -3 3 1', 'place red -3 3 -1', 'place red -2 3 1', 'place red -2 3 0', 'place red -2 3 -1']
