...
"""
Will generate two-instruction dialogues where the builder follows both instructions correctly but the 
architect has made a mistake in his instructions and so the builder has to remove/replace certain blocks. 
