...
val_dataset = load_dataset("json", data_files={'val':'/tmpdir/thompson/parser_data/synthetic_corrections_LONG_GEN_test.jsonl'})["val"]  
...
f = open("/tmpdir/thompson/llama-trois-parser/synth_correction_LONG_GEN_test.txt","w")

new_generations = None
previous_generations = None
for datum in tqdm(val_dataset['sample']):
